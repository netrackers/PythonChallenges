...
def main():
    ...
    num_emps = int( input('How many employee records do you'\
    + 'want to create? '))
    # Open a file for writing
    emp_file = open('employees.txt', 'w')

    # Get each employee's data and write it to the file
    for employee in range(1, num_emps + 1):
        
        # Get the date for an employee.
        print('Enter data for employee #', employee, sep='')
        name = input('Name: ')
